...
{
    public partial class AddSmallTalkSeedData : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("0ab7c90d-82c5-4820-867c-bd93a1508ec7"), "Greeting", "Smalltalk.Greetings.Bye", "Later.", "Humorous" },
                    ...
                    { new Guid("6af7fff2-bc94-4ecd-b1bb-a1976e1709de"), "Greeting", "Smalltalk.Greetings.Bye", "See ya!", "Humorous" },
                    { new Guid("8245aad3-cd50-458b-bf32-bfd82e699e08"), "Greeting", "Smalltalk.Greetings.Bye", "Smell ya later!", "Humorous" },
                    { new Guid("59389128-decc-4362-b9b3-9c6c8840ad51"), "Greeting", "Smalltalk.Greetings.GoodEvening", "Good evening", "Humorous" },
                    ...
                    { new Guid("b5cbffff-7588-4e0a-9e81-dcc8fd1b891b"), "Greeting", "Smalltalk.Greetings.GoodNight", "Don't let the bed bugs bite.", "Humorous" },
                    { new Guid("7ffc8cb3-ccc5-4c43-9c41-6f0b791b8312"), "Greeting", "Smalltalk.Greetings.GoodNight", "Night", "Humorous" },
                    { new Guid("b67cdd5e-170d-415d-a406-b02cada5d306"), "Greeting", "Smalltalk.Greetings.GoodNight", "Goodnight", "Humorous" },
                    { new Guid("b4890e6e-390c-4310-bca1-f24132823977"), "Greeting", "Smalltalk.Greetings.GoodMorning", "Morning!", "Humorous" },
                    { new Guid("dfa176e8-093a-425b-8d84-570c35e95847"), "Greeting", "Smalltalk.Greetings.GoodMorning", "Morning, how are you today?", "Humorous" },
                    { new Guid("e02007c5-e6a9-4b78-8789-886483cc461c"), "Greeting", "Smalltalk.Greetings.GoodMorning", "Back atcha.", "Humorous" },
                    { new Guid("1932c98a-da48-422a-8b66-724ed9063a72"), "Greeting", "Smalltalk.Greetings.GoodEvening", "Back atcha.", "Humorous" },
                    { new Guid("99f6a538-fd7a-471a-8ec1-dc883c48c588"), "Greeting", "Smalltalk.Greetings.GoodEvening", "Evening gov'na.", "Humorous" },
                    { new Guid("dc99166b-1efa-4763-99b3-18c5875fe879"), "Greeting", "Smalltalk.Greetings.GoodEvening", "And to you as well, human.", "Humorous" },
                    { new Guid("1857a0c7-be5e-4908-a85e-9d69015856e3"), "Greeting", "Smalltalk.Greetings.GoodEvening", "Evening", "Humorous" },
                    ...
                    { new Guid("d6ff8c0b-0dcd-4320-bbd5-e2eee71ad124"), "Greeting", "Smalltalk.Greetings.Bye", "See ya!", "Friendly" },
                    { new Guid("90283c2e-3106-4348-bb5d-62f649a95138"), "Greeting", "Smalltalk.Greetings.Bye", "Bye!", "Friendly" },
                    { new Guid("ebcd6175-c10b-445e-b195-03741a614ee2"), "Greeting", "Smalltalk.Greetings.Bye", "Bye!", "Friendly" },
                    ...
                    { new Guid("1ad4a7f5-6690-4559-a253-c9e4ebcd3d77"), "Greeting", "Smalltalk.Greetings.Bye", "Catch ya later!", "Friendly" },
                    ...
                    { new Guid("db39f809-9f13-45c5-890f-71575a0ac7cb"), "Greeting", "Smalltalk.Greetings.GoodEvening", "Good evening", "Friendly" },
                    { new Guid("f709aba7-df74-47cc-bac8-1edf084313db"), "Greeting", "Smalltalk.Greetings.GoodEvening", "Evening", "Friendly" },
                    ...
                    { new Guid("85284f6c-3510-435b-b233-358a5d5a9632"), "Greeting", "Smalltalk.Greetings.GoodEvening", "Evening 😊", "Friendly" },
                    ...
                    { new Guid("0ddc9784-77b8-47a0-9f60-22d01d53776c"), "Greeting", "Smalltalk.Greetings.GoodNight", "Night 🌝", "Friendly" },
                    { new Guid("4b1e01ac-20ff-446d-b959-3d9345de0b53"), "Greeting", "Smalltalk.Greetings.GoodNight", "Goodnight!", "Friendly" },
                    { new Guid("4c1c273e-f1bb-4fbf-a755-e273b55b929d"), "Greeting", "Smalltalk.Greetings.GoodMorning", "Morning!!", "Friendly" },
                    { new Guid("165d09f1-5a57-4491-8f1f-0818f5ac88f4"), "Greeting", "Smalltalk.Greetings.GoodMorning", "Good Morning", "Friendly" },
                    { new Guid("0dcc8928-083c-4db9-b403-22dd462d65ef"), "Greeting", "Smalltalk.Greetings.GoodMorning", "Good Morning 😊", "Friendly" },
                    ...
                    { new Guid("28e40ae1-24cd-44f7-b1de-567cf8736f70"), "Greeting", "Smalltalk.Greetings.GoodNight", "Night", "Professional" },
                    { new Guid("8df780f6-11ff-4d1c-8d85-621ce5209554"), "Greeting", "Smalltalk.Greetings.GoodNight", "Goodnight", "Professional" },
                    { new Guid("e4eb67a7-79c5-4ebc-9060-7eed2f7cf5ff"), "Greeting", "Smalltalk.Greetings.GoodMorning", "Morning, how are you today?", "Professional" },
                    { new Guid("a779e63b-6852-459f-81ed-eae1fbebd8c5"), "Dialog", "Smalltalk.Dialog.Polite", "No worries.", "Professional" },
                    { new Guid("18e82fa4-6fbe-4d56-a499-cc8f65cb6f85"), "Greeting", "Smalltalk.Greetings.GoodMorning", "Good Morning", "Professional" },
                    { new Guid("c7711619-0bc3-4336-8b49-a0e64941e44c"), "Greeting", "Smalltalk.Greetings.GoodEvening", "Good evening", "Professional" },
                    { new Guid("b5e0af2f-35a4-4fc3-a7cc-b7c36f722f59"), "Greeting", "Smalltalk.Greetings.Bye", "Talk to you later.", "Professional" },
                    { new Guid("61587038-23bf-4d14-9afd-5d1c0dcc1438"), "Greeting", "Smalltalk.Greetings.Bye", "Goodbye.", "Professional" },
                    ...
                    { new Guid("a3a2ac9b-759b-4aea-acfd-a93a682f6a61"), "Greeting", "Smalltalk.Greetings.GoodEvening", "Evening", "Professional" },
