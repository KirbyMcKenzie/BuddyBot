...
namespace BuddyBot.Dialogs
{
    ...
    public class ShowcaseDialog : IDialog<string>
    {
        ...
        private async Task CauseChaos(IDialogContext context)
        {
            ...
            await context.PostAsync("Downloading: Chatbot");
            System.Threading.Thread.Sleep(500);
            await context.PostAsync("Downloading: Artificial intelligence");
            System.Threading.Thread.Sleep(500);
            await context.PostAsync("Downloading: Computer Science");
            System.Threading.Thread.Sleep(500);
            await context.PostAsync("Downloading: Computation");
            System.Threading.Thread.Sleep(500);
            await context.PostAsync("Downloading: Computers");
            System.Threading.Thread.Sleep(500);
            await context.PostAsync("Downloading: Machine");
            System.Threading.Thread.Sleep(500);
            ...
            System.Threading.Thread.Sleep(1500);
            await context.PostAsync("Downloading: Experience");
            System.Threading.Thread.Sleep(1500);
